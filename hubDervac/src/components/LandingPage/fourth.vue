  ...
  <div class="md:px-24 px-8 py-[96px] bg-white">
    <div class="flex md:flex-row flex-col justify-between items-center">
      ...
      <div class="my-[20px] grid md:grid-cols-2 lg:grid-cols-3 gap-[30px] md:my-2">
        <!-- <TrainingSection field="Digital Literacy" desc="Build a solid foundation in computer fundamentals and data processing. Learn essential digital skills, from hardware and software basics to file management and data manipulation. Develop practical competence for navigating the digital landscape. Ideal for beginners and anyone seeking to enhance their digital proficiency."  Module="Module 1" time="4 Weeks"  /> -->
